...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{PERSONAL_INFO.name} | Contact</title>
        <meta name="description" content={`Contact ${PERSONAL_INFO.name}`} />
      </Helmet>
              ...
              <div className="bg-white/5 rounded-2xl p-8 border border-white/10 h-full">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a href={`mailto:${PERSONAL_INFO.email}`} className="text-white/80 hover:text-white transition-colors">
                      {PERSONAL_INFO.email}
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <a href={`tel:${PERSONAL_INFO.phone.replace(/\s+/g, '')}`} className="text-white/80 hover:text-white transition-colors">
                      {PERSONAL_INFO.phone}
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <address className="text-white/80 not-italic">
                      {PERSONAL_INFO.location.split(', ').map((line, i) => <React.Fragment key={i}>{line}<br/></React.Fragment>)}
                    </address>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a href={PERSONAL_INFO.socials.linkedin} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                        <Linkedin className="h-5 w-5" />
                      </a>
                      <a href={PERSONAL_INFO.socials.github} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                        <Github className="h-5 w-5" />
                      </a>
                      {PERSONAL_INFO.socials.twitter && (
                        <a href={PERSONAL_INFO.socials.twitter} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
